...
const DEFAULTS = {
  ...
  // عينات ترقيم المستندات — تظهر حتى لو فشل /settings مؤقتًا
  receiptsPrefix: 'RC',
  receiptsWidth: 5,
  receiptsNext: 1,
  receiptsSample: 'RC00001',
  paymentsPrefix: 'PY',
  paymentsWidth: 5,
  paymentsNext: 1,
  paymentsSample: 'PY00001',
  journalDocsPrefix: 'JV',
  journalDocsWidth: 5,
  journalDocsNext: 1,
  journalDocsSample: 'JV00001',
  bankEntriesPrefix: 'BE',
  bankEntriesWidth: 5,
  bankEntriesNext: 1,
  bankEntriesSample: 'BE00001',
  purchaseInvoicesPrefix: 'PI',
  purchaseInvoicesWidth: 5,
  purchaseInvoicesNext: 1,
  purchaseInvoicesSample: 'PI00001',
  creditNotesPrefix: 'CN',
  creditNotesWidth: 5,
  creditNotesNext: 1,
  creditNotesSample: 'CN00001',
  debitNotesPrefix: 'DN',
  debitNotesWidth: 5,
  debitNotesNext: 1,
  debitNotesSample: 'DN00001',
};
