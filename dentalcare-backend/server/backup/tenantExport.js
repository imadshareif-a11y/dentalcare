...
const TABLE_QUERIES = [
  ...
  { key: 'rooms', sql: `SELECT * FROM rooms WHERE tenant_id = $1` },
  ...
  { key: 'treatment_plans', sql: `SELECT * FROM treatment_plans WHERE tenant_id = $1` },
  { key: 'treatment_plan_items', sql: `SELECT * FROM treatment_plan_items WHERE tenant_id = $1` },
  { key: 'tooth_chart_entries', sql: `SELECT * FROM tooth_chart_entries WHERE tenant_id = $1` },
